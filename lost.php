...
if(isset($_POST['submit']))
{
    ...
    $date = $_POST['date'];
    $time = $_POST['time'];
    $query = "INSERT INTO lost_items (user_email, item_type, company, color, location, lost_date, lost_time) VALUES ('$email','$item','$company','$color','$location','$date','$time')";
    if(mysqli_query($conn, $query))
    {
        echo "<p style='color:green;'>✅ Item Reported Successfully</p>";
        $_SESSION['from']="lost";
        $r = mysqli_query($conn, "SELECT MAX(id) FROM lost_items");
    ...
    <body>
        ...
        <script>
            ...
            const companyOptions = {
                mobile: ["Apple", "Samsung", "MI", "Realme", "OnePlus", "Oppo", "Vivo", "Motorola", "Infinix", "Huawei", "Nokia", "Poco", "Xiaomi", "Redmi"],
                laptop: ["Dell", "HP", "Lenovo", "Apple", "Asus", "Acer", "MSI", "Motorola"],
                watch: ["Boat", "Fastrack", "Noise", "Titan", "Apple", "Samsung", "Rolex", "Croma"],
                bag: ["Wildcraft", "Skybags", "Puma", "Adidas", "Nike"],
                bottle: ["Milton", "Cello", "Tupperware", "Borosil"],
                umbrella: ["Puma", "Nike", "Reebok", "allen", "K. C. Paul", "PW", "Local"]
            };
